...
w <- tuneR::readWave('cymbal-hihat-stick.wav')
#plot Wave
plot(w)
```
...
Data sonification is particularly interesting when it is combined with data animation, as shown in the example below based on the package [gganimate](https://gganimate.com/index.html).
